...
artist = supp.find('a', class_='Link__StyledLink-h3isu4-0 cmikaN SongHeaderVariantdesktop__Artist-sc-12tszai-11 ayFeg').get_text() #leiab laulu artisti
pealkiri = supp.find('h1', class_='SongHeaderVariantdesktop__Title-sc-12tszai-7 iWUdKG').get_text() #leiab laulu pealkirja
